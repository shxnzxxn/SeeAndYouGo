...
public class CrowdRepository {
    ...
    public int[] callData(String resName) {
        ...
        // Integer connectedUsers = jdbcTemplate.queryForObject(capacitySql, new
        // Object[] { resName }, Integer.class);
        Integer connectedUsers = jdbcTemplate.queryForObject(connectedSql, new Object[] { resName }, Integer.class);
    ...
    // String apiUrl = "http://localhost:3000/svc/offcam/pub/WifiAllInfo"; // API
    // 엔드포인트
    // String queryParams =
    // "?AUTH_KEY=asd&limit_seconds=100000&limit_requests=100000"; // 필요한 매개변수
    //
    // // URL 생성
